...
MakeHikeItem.prototype.render = function() {
  ...
  this.$element = results
    .append('<h2>Your suggested hike is:</h2><br><h3>'+this.name+'</h3>')
    .append('<div class="row"><div class="col-md-4 col-md-offset-2"><a href="#" class="thumbnail"><img src='+this.img+'></a></div><div class="col-md-4"><p>'+this.info+'</p></div>')
    .append('<div class="row"><div class="col-md-4 col-md-offset-2"><ul class="list-group"><li class="list-group-item"><strong>Location: </strong>'+this.location+'</li><li class="list-group-item"><strong>Distance: </strong>'+this.distance+' miles</li><li class="list-group-item"><strong>Duration: </strong>'+this.duration+' hours</li><li class="list-group-item"><strong>Difficulty: </strong>'+this.toString()+'</li><li class="list-group-item"><strong>Features: </strong>'+this.feature+'</li></ul></div></div>')
    .append('<div class="col-md-8" id="map">'+this.map+'</div></div>');
};
